...
//                mSwipeRefreshLayout.setRefreshing(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_offerings);
                    ...
                    if (throwable == null) {
                        ...
                        if (!results.isEmpty()) {
                            ...
                            if (!"Y".equals(fromSkip) && fromLogin) {
                                goingOut = true;
                                Intent intent = new Intent(OfferingListActivity.this, EditUserProfileActivity.class);
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (id) {
                            ...
                            case R.id.profile:
                                startActivity(new Intent(OfferingListActivity.this, ViewUserProfileActivity.class));
                                break;
